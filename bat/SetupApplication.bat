...
:: Android packaging
set AND_CERT_NAME="qqx5"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\qqx5.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=cert\key.p12
set IOS_DEV_CERT_FILE=cert\key.p12
set IOS_DEV_CERT_PASS=9ria
set IOS_PROVISION=cert\9ria.mobileprovision
set IOS_ICONS=icons\
